  ...
  procesosDisponibles: Proceso[] = [
    ...
    },
    {
      ...
      columnas: [
        ...
        { field: 'NumeroFacturaImportador', header: 'N° FACTURA IMPORTADOR' },
        { field: 'FechaFacturaImportador', header: 'F. FACTURA IMPORTADOR' },
        { field: 'FechaCancelacionImportador', header: 'FECHA DE CANCELACION IMPORTADOR' },
        ...
        { field: 'AccesoriosJunto', header: 'ACCESORIOS JUNTO' },
        { field: 'Rrpp', header: 'RRPP' },
        { field: 'Flete', header: 'FLETE' },
        { field: 'GastosAdministrativos', header: 'GASTOS ADMINISTRATIVOS' },
        { field: 'Fletes', header: 'FLETES' },
        { field: 'DescripcionRuta', header: 'DESCRIPCION RUTA' },
        { field: 'FechasFacturaTransporte', header: 'FECHAS DE FACTURA TRANSPORTE' },
        ...
        { field: 'FechaEntrega', header: 'FEC.ENTREGA' },
